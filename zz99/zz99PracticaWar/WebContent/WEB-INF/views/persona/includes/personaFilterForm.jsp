...
<form:form modelAttribute="PersonaFilter" id="persona_filter_form">
	<!-- Barra de herramientas del formulario de filtrado -->
	<div id="persona_feedback"></div>
	<div id="persona_filter_toolbar" class="formulario_legend"></div>
	<fieldset id="persona_filter_fieldset"
		...
		<div id="persona_filter_buttonSet" class="text-right">
			<!-- Botón de filtrado -->
			<button id="persona_filter_filterButton" type="button"
				class="btn-material btn-material-primary-high-emphasis">
				<i class="mdi mdi-filter"></i> <span><spring:message
						code="filter" /></span>
			</button>
			<!-- Botón de limpiar -->
			<button id="persona_filter_cleanButton" type="button"
